...
def initialize_bigquery_datamart(project_id: str | None = None, dataset: str | None = None) -> None:
    ...
    execute_sql(client, render_sql("vw_macro_latest_all_regions.sql", project_id=project_id, dataset=dataset))
    execute_sql(client, render_sql("vw_macro_latest_sido.sql", project_id=project_id, dataset=dataset))
    execute_sql(client, render_sql("vw_macro_latest_key_sigungu.sql", project_id=project_id, dataset=dataset))
